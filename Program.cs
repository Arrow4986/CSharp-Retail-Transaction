...
{
    int currentTwenties = cashTill[3] + twenties;
    int currentTens = cashTill[2] + tens;
    int currentFives = cashTill[1] + fives;
    int currentOnes = cashTill[0] + ones;
    ...
    cashTill[3] = currentTwenties;
    cashTill[2] = currentTens;
    cashTill[1] = currentFives;
    cashTill[0] = currentOnes;
